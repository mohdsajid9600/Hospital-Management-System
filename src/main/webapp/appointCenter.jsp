...
<body style="background-color: #00827F;">
	...
	<div class="container">
		<div class="row">
			<div
				class="col col-md-6 p-3 bg-image mt-3 text-center paint-card rounded mb-3 f-color"
				style="background-image: url('img/appointment-img-5.jpg'); background-repeat: no-repeat; background-size: cover;">
				<h1 class="mt-5 p-5 mb-4 h1">
				...
				<p class="fs-5">
					<em>Lorem ipsum dolor, sit amet consectetur adipisicing elit.
						...
						unde? Aut dolorum quod excepturi fugit.</em>
				</p>
			</div>
			<div class="col col-md-6 p-3">
				<div class="card paint-card
					text-light" style="background-color: #045D5D;">
					<div class="card-body">
							...
							<div class="row">
								...
								<c:if test="${not empty userObj}">
									<div class="col-md-12 text-center mt-3">
										<button type="submit"
											class="btn btn-dark btn-block btn-sm col-md-12">Make Appointment</button>
									</div>
								</c:if>
								<c:if test="${empty userObj}">
									<div class="mb-3 text-center mt-3" style="color: white;">
										<a href="user_login.jsp"
											class="btn btn-dark btn-block btn-sm col-md-12"
