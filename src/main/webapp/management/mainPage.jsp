...
<body>
	...
	<div class="container p-3">
		<p class="text-center fs-2 fw-bold f-color">Key
				...
				<div class="row">
					<div class="col-md-6">
						<div
							...
							<div class="card-body fw-bold img-text-color">
					...
					<div class="col-md-6">
						<div
							...
							<div class="card-body fw-bold img-text-color">
								...
								<p>There is no visible dirt/grease/stains in any area of the
					...
					<div class="col-md-6">
						<div class="card mb-2 paint-card text-center bg-image text-light"
							...
							<div class="card-body fw-bold img-text-color">
								...
								<p>A great hospital should also take pride in its doctors.
					...
					<div class="col-md-6 ">
						<div class="card mb-2 paint-card text-center bg-image text-light "
							...
							<div class="card-body fw-bold img-text-color">
								...
								<p>hospital, an institution that is built, staffed, and
